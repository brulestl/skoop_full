            ...
            <div className="grid gap-8 md:grid-cols-3 max-w-5xl mx-auto">
              ...
              <div className="skoop-card p-6 flex flex-col h-full border border-border">
                ...
                <ul className="space-y-3 mb-8">
                  <li className="flex items-start">
                    ...
                    <span><span className="editable-text">500 saved items</span></span>
                  </li>
                  <li className="flex items-start">
                    <CheckCircle2 className="h-5 w-5 text-primary mr-3 mt-0.5 flex-shrink-0" />
              ...
              <div className="skoop-card p-6 flex flex-col h-full border-2 border-primary relative">
                ...
                <div className="mb-6">
                  ...
                  <div className="text-3xl font-bold"><span className="editable-text">$9</span><span className="text-muted-foreground text-sm font-normal"><span className="editable-text">/month</span></span></div>
              ...
              <div className="skoop-card p-6 flex flex-col h-full border border-border">
                <div className="mb-6">
                  <h3 className="text-lg font-medium mb-2"><span className="editable-text">Team</span></h3>
                ...
                <div className="mt-auto">
                  <Button className="w-full skoop-button-primary"><span className="editable-text">Choose Team</span></Button>
                </div>
              </div>
            </div>
          </div>
