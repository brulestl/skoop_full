              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-1">
                    ...
                    {save.tags.map((tag, i) => <span key={tag} className="text-xs px-1.5 py-0.5 rounded-full bg-secondary text-secondary-foreground mr-1">
                        {tag}
                      </span>)}
                  </div>
                  <span className="text-xs text-muted-foreground"><span className="editable-text">
