  ...
  return (
    <div className="h-screen flex flex-col">
      ...
      <header className="border-b border-border h-14 flex items-center px-4 justify-between">
        <div className="flex items-center">
          ...
          <Link href="/" className="flex items-center">
            <span className="font-bold text-lg text-primary mr-2">SKOOP</span>
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside
          className={cn(
            "border-r border-border transition-all duration-300 ease-in-out bg-background",
            ...
            <div className="flex flex-col h-full">
              ...
              <nav className="flex-1 px-3 py-2">
                ...
                <div className="mb-8 space-y-1">
                  {navigationItems.map((item) => (
                    <button
                      ...
                      className={cn(
                        "w-full flex items-center justify-between px-2 py-1.5 rounded-md group",
                        activeTab === item.id
                ...
                <div className="space-y-1">
                  <h3 className="text-sm font-medium text-muted-foreground px-2 py-1.5">
                    Connected Services
                  </h3>
                  {["GitHub", "Twitter", "Reddit", "Stack Overflow"].map(
                    (service) => (
                      <div
                        key={service}
