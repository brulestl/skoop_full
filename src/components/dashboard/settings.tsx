        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
            <label className={cn("border rounded-md p-4 flex items-start cursor-pointer", selectedModel === 'claude-bedrock' ? "border-primary bg-primary/5" : "")}>
              <input type="radio" name="aiModel" className="mr-3 mt-1" checked={selectedModel === 'claude-bedrock'} onChange={() => handleModelChange('claude-bedrock')} />
              <div>
                <div className="font-medium"><span className="editable-text">Claude (Anthropic)</span></div>
                <div className="text-muted-foreground text-sm"><span className="editable-text">Advanced understanding with nuanced responses</span></div>
              </div>
            </label>
            ...
            <label className={cn("border rounded-md p-4 flex items-start cursor-pointer", selectedModel === 'azure-gpt-4o' ? "border-primary bg-primary/5" : "")}>
              <input type="radio" name="aiModel" className="mr-3 mt-1" checked={selectedModel === 'azure-gpt-4o'} onChange={() => handleModelChange('azure-gpt-4o')} />
              <div>
                <div className="font-medium"><span className="editable-text">GPT-4o (OpenAI)</span></div>
                <div className="text-muted-foreground text-sm"><span className="editable-text">Powerful reasoning with technical expertise</span></div>
              </div>
            </label>
          </div>
        </div>
