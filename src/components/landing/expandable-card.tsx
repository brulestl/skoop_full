...
export default function ExpandableCard() {
  ...
  return <div className="w-full max-w-[640px] mx-auto" data-unique-id="46ff69ab-c761-45a3-b429-9c46c3000f8e" data-file-name="components/landing/expandable-card.tsx">
      ...
      duration: 0.4,
      ease: 'easeInOut'
    }} data-unique-id="1f834843-e743-4678-a062-1987435764e1" data-file-name="components/landing/expandable-card.tsx" data-dynamic-text="true">
        {/* Card Header - Always visible */}
        <div className="p-4 flex items-center cursor-pointer" onClick={toggleExpand} data-unique-id="07d40ac1-d438-420d-8a5c-e34a55babb05" data-file-name="components/landing/expandable-card.tsx">
          <div className="h-12 w-12 rounded-full bg-secondary flex items-center justify-center mr-3" data-unique-id="14dc5b6e-7b6e-4bf2-8a89-7048b31c0e3f" data-file-name="components/landing/expandable-card.tsx">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-unique-id="e3cc7910-b4c4-459e-ab1a-621da6b32a13" data-file-name="components/landing/expandable-card.tsx">
          ...
          <div className="flex-1 min-w-0" data-unique-id="6fb05923-f199-4ce1-8702-8d58cb57be4b" data-file-name="components/landing/expandable-card.tsx">
            <div className="flex items-center text-sm text-muted-foreground" data-unique-id="16458374-b86d-476b-844e-0192062e6e5b" data-file-name="components/landing/expandable-card.tsx">
              <span className="font-medium" data-unique-id="c447769b-aca5-4bca-b079-ee79e19b9def" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="51c3ac23-6beb-48a1-ad8c-91ae6a36f6ba" data-file-name="components/landing/expandable-card.tsx">@VectorGuru</span></span>
              <span className="mx-1" data-unique-id="669578f3-424e-4492-ab30-de43e732e88e" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="0096bb20-0a3b-409b-8399-5b755643e557" data-file-name="components/landing/expandable-card.tsx">·</span></span>
              <span data-unique-id="88322c57-3ddc-476e-a68d-514aa232d94d" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="7830a736-906d-4442-9103-a57fcf265429" data-file-name="components/landing/expandable-card.tsx">2h ago</span></span>
            </div>
            <p className="text-foreground font-medium mt-1 line-clamp-1" data-unique-id="314281be-f113-4363-b37e-5151eccd0610" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="a9e586d4-3d31-41e5-8ccd-8a414e684d7d" data-file-name="components/landing/expandable-card.tsx">
              🧵 Starting a deep-dive on vector search pitfalls you probably run into…
            </span></p>
          </div>

          <div className="flex items-center ml-4" data-unique-id="98c82c56-fbe3-4054-8a9a-a2dcb7daa12d" data-file-name="components/landing/expandable-card.tsx">
            <span className="px-2 py-1 text-xs rounded-full border border-primary text-primary mr-2" data-unique-id="cc7a2331-b4cc-4429-831b-0f08b5dc9875" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="ee5b3d6d-194c-4aee-97d6-8aaae9bc3d5b" data-file-name="components/landing/expandable-card.tsx">
              Saved to SKOOP
            </span></span>
            <button ref={buttonRef} onClick={e => {
            e.stopPropagation();
            toggleExpand();
          }} className="p-1 rounded-full hover:bg-muted transition-colors" aria-expanded={isExpanded} aria-controls="expandable-content" data-unique-id="ea678584-f432-41f6-b2d0-f3f7e1d55dfb" data-file-name="components/landing/expandable-card.tsx">
              <motion.div animate={{
              rotate: isExpanded ? 180 : 0
            }} transition={{
              duration: 0.3
            }} data-unique-id="a6c23284-c651-44b4-82fc-5430bc417c87" data-file-name="components/landing/expandable-card.tsx">
        ...
        <AnimatePresence>
          ...
          duration: 0.4,
          ease: 'easeInOut'
        }} className="px-4 pb-4" tabIndex={-1} role="region" aria-labelledby="expandable-card-title" data-unique-id="a42bc647-c4ab-41c6-ac76-2875d0cda933" data-file-name="components/landing/expandable-card.tsx" data-dynamic-text="true">
              {/* AI Summary */}
              <div className="border-l-4 border-primary pl-4 py-2 mb-4 bg-primary/5 rounded-r" data-unique-id="99131d4a-8b75-419f-b410-b4868bc65cac" data-file-name="components/landing/expandable-card.tsx">
                <p className="text-gray-700 dark:text-gray-300 font-medium" data-unique-id="24609f5a-33a0-4409-bfe8-4192f7813b51" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="c4df28a2-2874-4abf-8376-a18b73166fe1" data-file-name="components/landing/expandable-card.tsx">
              ...
              {/* Key Points */}
              <div className="mb-6" data-unique-id="c29a0311-9f14-4ae6-a599-fc82bf6bc9a2" data-file-name="components/landing/expandable-card.tsx">
                <h3 className="text-sm font-medium mb-2" data-unique-id="59229f3e-2a0c-4e58-a631-5e2b6e489f76" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="985a83ca-83eb-4287-905f-9972c677071a" data-file-name="components/landing/expandable-card.tsx">Key Points</span></h3>
                <ul className="space-y-2" data-unique-id="ef6d517c-c4cd-40ce-9bd6-84ed5eec1f1c" data-file-name="components/landing/expandable-card.tsx">
                  <li className="flex items-start" data-unique-id="d1a37b6a-f235-41b0-85bb-41b6a5f76718" data-file-name="components/landing/expandable-card.tsx">
                    <div className="mt-1 mr-2 p-1 rounded-full bg-primary/10" data-unique-id="63b122b0-05e4-4cdc-bca3-8134d4e2556d" data-file-name="components/landing/expandable-card.tsx">
                      <Check className="h-3 w-3 text-primary" />
                    </div>
                    <span className="text-[#4B5563]" data-unique-id="2231d92c-8c0c-4994-b28b-2743a594e34e" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="a4909e2a-0481-4d6d-b240-ed0ffee3898a" data-file-name="components/landing/expandable-card.tsx">Fine-tune embeddings when domain jargon is heavy.</span></span>
                  </li>
                  <li className="flex items-start" data-unique-id="95d34b5b-3c13-4317-9976-bec80d119248" data-file-name="components/landing/expandable-card.tsx">
                    <div className="mt-1 mr-2 p-1 rounded-full bg-primary/10" data-unique-id="c7c2fe55-b13a-4a4b-bd8c-97ac7ff6b98b" data-file-name="components/landing/expandable-card.tsx">
                      <Check className="h-3 w-3 text-primary" />
                    </div>
                    <span className="text-[#4B5563]" data-unique-id="068e0474-9948-4628-9d9f-033445dce894" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="62ced6d8-2eb4-4e29-a026-badcc052d79e" data-file-name="components/landing/expandable-card.tsx">Normalize vectors and text metadata before similarity calc.</span></span>
                  </li>
                  <li className="flex items-start" data-unique-id="8e9e5336-2feb-4904-8a27-0eb10579a5c4" data-file-name="components/landing/expandable-card.tsx">
                    <div className="mt-1 mr-2 p-1 rounded-full bg-primary/10" data-unique-id="4330042f-59b4-48fe-b955-bb3a5f4d5024" data-file-name="components/landing/expandable-card.tsx">
                      <Check className="h-3 w-3 text-primary" />
                    </div>
                    <span className="text-[#4B5563]" data-unique-id="5c314a2f-d279-4bc3-a86c-cf3caca23afd" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="12fd0d01-2609-4e9e-aab4-c6c640bb157b" data-file-name="components/landing/expandable-card.tsx">Post-filter with recency or popularity signals.</span></span>
                  </li>
                </ul>
              </div>

              {/* Footer Actions */}
              <div className="flex items-center justify-between pt-3 border-t border-border" data-unique-id="87763b2e-9699-4264-9a8e-810297889854" data-file-name="components/landing/expandable-card.tsx">
                <div className="flex items-center gap-2" data-unique-id="937cd042-e007-47a5-9ee9-b500a42c5d4c" data-file-name="components/landing/expandable-card.tsx">
                  <Button className="bg-gradient-to-r from-primary to-accent text-white" onClick={() => window.open('https://twitter.com/VectorGuru/status/123456', '_blank')} data-unique-id="93b855fa-81de-4f74-b518-7a3dd546a35e" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="18d25c9b-2a50-455a-a8f7-df03f23a2d90" data-file-name="components/landing/expandable-card.tsx">
                    Open Full Thread
                  </span></Button>
                  
                  <Button variant="ghost" size="icon" data-unique-id="aecef357-db3a-4d7b-89ce-a0b08b1e6999" data-file-name="components/landing/expandable-card.tsx">
                    <Share2 className="h-4 w-4" />
                    <span className="sr-only" data-unique-id="f7c4408a-e9dd-4ca1-b9a8-4262875f8e04" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="27a29da1-c1bf-4d8b-a4cc-33234c7b3e5a" data-file-name="components/landing/expandable-card.tsx">Share</span></span>
                  </Button>
                </div>
              ...
              e.stopPropagation();
              toggleExpand();
            }} data-unique-id="3f050544-abb9-42d1-af8e-d585204fb7ad" data-file-name="components/landing/expandable-card.tsx">
                  <ChevronUp className="h-4 w-4 mr-1" /><span className="editable-text" data-unique-id="eeeecd7f-f348-46af-9f09-d8a5f661a38b" data-file-name="components/landing/expandable-card.tsx">
                  Collapse
                </span></Button>
              </div>
            </motion.div>}
