...
export default function ExpandableCard() {
  ...
  return <div className="w-full max-w-[640px] mx-auto" data-unique-id="e74e1747-4521-48c5-aa59-aa58c9103a01" data-file-name="components/landing/expandable-card.tsx">
      ...
      duration: 0.4,
      ease: 'easeInOut'
    }} data-unique-id="dd84fe94-f543-41ce-8ac2-3bb8e4e55a8f" data-file-name="components/landing/expandable-card.tsx" data-dynamic-text="true">
        {/* Card Header - Always visible */}
        <div className="p-4 flex items-center cursor-pointer" onClick={toggleExpand} data-unique-id="a2df9e94-149d-4b5f-932d-785b417a85ab" data-file-name="components/landing/expandable-card.tsx">
          <div className="h-12 w-12 rounded-full bg-secondary flex items-center justify-center mr-3" data-unique-id="044c98b5-c9f0-4df4-9b1d-07bdc92e53de" data-file-name="components/landing/expandable-card.tsx">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-unique-id="4b3df75e-3042-45fd-9ab1-77907de13dc3" data-file-name="components/landing/expandable-card.tsx">
          ...
          <div className="flex-1 min-w-0" data-unique-id="bd579697-22fa-4709-bc40-3909c71839a3" data-file-name="components/landing/expandable-card.tsx">
            <div className="flex items-center text-sm text-muted-foreground" data-unique-id="050d4463-5bb2-4553-b4d1-fb4cb9e0a25f" data-file-name="components/landing/expandable-card.tsx">
              <span className="font-medium" data-unique-id="1305466b-cc6c-4b1e-99cd-e6b3b275d6b7" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="718d90ba-62b2-48f5-bc94-59f066f4de81" data-file-name="components/landing/expandable-card.tsx">@VectorGuru</span></span>
              <span className="mx-1" data-unique-id="5b4e9b30-b73c-4a91-bc63-751d31067b90" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="99a548f6-6acb-4f7e-9406-97bc670a503f" data-file-name="components/landing/expandable-card.tsx">·</span></span>
              <span data-unique-id="df48330e-27ce-487c-8957-8d6b44c14b0e" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="06d065b2-ba08-4184-b84d-1dd3c1859163" data-file-name="components/landing/expandable-card.tsx">2h ago</span></span>
            </div>
            <p className="text-foreground font-medium mt-1 line-clamp-1" data-unique-id="ba889353-b5fd-4d1a-834f-35bd2e83b7d4" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="30cee167-35a1-4bf4-b63a-b14d3b385937" data-file-name="components/landing/expandable-card.tsx">
              🧵 Starting a deep-dive on vector search pitfalls you probably run into…
            </span></p>
          </div>

          <div className="flex items-center ml-4" data-unique-id="8a143fa1-94f0-4b88-ac5b-d78695cff873" data-file-name="components/landing/expandable-card.tsx">
            <span className="px-2 py-1 text-xs rounded-full border border-primary text-primary mr-2" data-unique-id="6ecae3c8-d3f3-420d-90a1-03a3ca9f8b1d" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="cec3d72b-95a1-4871-9764-a66f45e4621d" data-file-name="components/landing/expandable-card.tsx">
              Saved to SKOOP
            </span></span>
            <button ref={buttonRef} onClick={e => {
            e.stopPropagation();
            toggleExpand();
          }} className="p-1 rounded-full hover:bg-muted transition-colors" aria-expanded={isExpanded} aria-controls="expandable-content" data-unique-id="334cc186-94f8-4338-8c33-1d4a0ac73d15" data-file-name="components/landing/expandable-card.tsx">
              <motion.div animate={{
              rotate: isExpanded ? 180 : 0
            }} transition={{
              duration: 0.3
            }} data-unique-id="e989a48b-e2f8-4f62-a9c7-630bce8c08ef" data-file-name="components/landing/expandable-card.tsx">
        ...
        <AnimatePresence>
          ...
          duration: 0.4,
          ease: 'easeInOut'
        }} className="px-4 pb-4" tabIndex={-1} role="region" aria-labelledby="expandable-card-title" data-unique-id="3a3fde2e-ec7c-428c-819b-ec86894f570e" data-file-name="components/landing/expandable-card.tsx" data-dynamic-text="true">
              {/* AI Summary */}
              <div className="border-l-4 border-primary pl-4 py-2 mb-4 bg-primary/5 rounded-r" data-unique-id="e9b9c0d6-44c8-475d-8107-be07ca46b762" data-file-name="components/landing/expandable-card.tsx">
                <p className="text-gray-700 dark:text-gray-300 font-medium" data-unique-id="06ebc86f-0737-493c-befb-9500adab9813" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="832d4f3f-0e85-4db7-b28f-53a50602c7a4" data-file-name="components/landing/expandable-card.tsx">
              ...
              {/* Key Points */}
              <div className="mb-6" data-unique-id="ccb356d7-b02a-480d-80b3-39f0f912cee2" data-file-name="components/landing/expandable-card.tsx">
                <h3 className="text-sm font-medium mb-2" data-unique-id="46362016-4316-46a2-8656-0a3f5f915910" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="63db09ab-390d-4958-aa16-f5bd50446258" data-file-name="components/landing/expandable-card.tsx">Key Points</span></h3>
                <ul className="space-y-2" data-unique-id="35cb0430-0a7d-4f67-b7b0-60b211afaedb" data-file-name="components/landing/expandable-card.tsx">
                  <li className="flex items-start" data-unique-id="f95ca496-020b-448b-8d03-7ba10abecde3" data-file-name="components/landing/expandable-card.tsx">
                    <div className="mt-1 mr-2 p-1 rounded-full bg-primary/10" data-unique-id="6a4a9464-0029-440b-8c71-ce2909d23a89" data-file-name="components/landing/expandable-card.tsx">
                      <Check className="h-3 w-3 text-primary" />
                    </div>
                    <span className="text-[#4B5563]" data-unique-id="570c92dc-7b76-421f-9726-27f8e33d4002" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="315ac839-2a9d-4c57-a552-bbb9e47bb947" data-file-name="components/landing/expandable-card.tsx">Fine-tune embeddings when domain jargon is heavy.</span></span>
                  </li>
                  <li className="flex items-start" data-unique-id="b3b384a2-b8bb-4cbf-a982-5a5dde7f172e" data-file-name="components/landing/expandable-card.tsx">
                    <div className="mt-1 mr-2 p-1 rounded-full bg-primary/10" data-unique-id="17e14f7e-4af6-4a16-ab30-37e8829a7bda" data-file-name="components/landing/expandable-card.tsx">
                      <Check className="h-3 w-3 text-primary" />
                    </div>
                    <span className="text-[#4B5563]" data-unique-id="1e1e0ddd-945f-48b9-a4d9-20e1825e0176" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="dd1466a6-c304-4c2e-aef6-7b3a30972fef" data-file-name="components/landing/expandable-card.tsx">Normalize vectors and text metadata before similarity calc.</span></span>
                  </li>
                  <li className="flex items-start" data-unique-id="b9282dd1-cfbb-467a-a8db-6b8f243f1c37" data-file-name="components/landing/expandable-card.tsx">
                    <div className="mt-1 mr-2 p-1 rounded-full bg-primary/10" data-unique-id="39d58f4e-d4db-4fc7-8b34-29ffd647722f" data-file-name="components/landing/expandable-card.tsx">
                      <Check className="h-3 w-3 text-primary" />
                    </div>
                    <span className="text-[#4B5563]" data-unique-id="bfcaea2a-4bca-424c-8931-1d02fec69c2c" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="efb28389-9913-47f3-9fb2-f3441fd880f9" data-file-name="components/landing/expandable-card.tsx">Post-filter with recency or popularity signals.</span></span>
                  </li>
                </ul>
              </div>

              {/* Footer Actions */}
              <div className="flex items-center justify-between pt-3 border-t border-border" data-unique-id="333d1692-28b7-4f60-ac61-b6cb9712aaaf" data-file-name="components/landing/expandable-card.tsx">
                <div className="flex items-center gap-2" data-unique-id="344a46dd-2b24-482b-a435-d351fefcec0f" data-file-name="components/landing/expandable-card.tsx">
                  <Button className="bg-gradient-to-r from-primary to-accent text-white" onClick={() => window.open('https://twitter.com/VectorGuru/status/123456', '_blank')} data-unique-id="9fd544b9-5dde-49c0-aaed-61d552596a35" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="093a3306-6a04-48d5-bcaa-da8733c108d0" data-file-name="components/landing/expandable-card.tsx">
                    Open Full Thread
                  </span></Button>
                  
                  <Button variant="ghost" size="icon" data-unique-id="09de0477-1f80-44d8-8bbb-da256d6c2295" data-file-name="components/landing/expandable-card.tsx">
                    <Share2 className="h-4 w-4" />
                    <span className="sr-only" data-unique-id="162c48f2-db2b-42a4-8ffc-9064dafa9e28" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="c4242fd3-0b3c-4966-af77-ce4a384db155" data-file-name="components/landing/expandable-card.tsx">Share</span></span>
                  </Button>
                </div>
              ...
              e.stopPropagation();
              toggleExpand();
            }} data-unique-id="9207201a-6137-4539-83b0-c9e92acae0f6" data-file-name="components/landing/expandable-card.tsx">
                  <ChevronUp className="h-4 w-4 mr-1" /><span className="editable-text" data-unique-id="533a0889-6772-4924-9a02-95b6d7b3ff8e" data-file-name="components/landing/expandable-card.tsx">
                  Collapse
                </span></Button>
              </div>
            </motion.div>}
