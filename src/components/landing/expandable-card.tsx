...
export default function ExpandableCard() {
  ...
  return <div className="w-full max-w-[640px] mx-auto" data-unique-id="e72ea298-6a77-4e92-9e65-0dc2bf5c5b12" data-file-name="components/landing/expandable-card.tsx">
      ...
      duration: 0.4,
      ease: 'easeInOut'
    }} data-unique-id="b1bd5e40-da25-46cd-a68c-7a57d67cb645" data-file-name="components/landing/expandable-card.tsx" data-dynamic-text="true">
        {/* Card Header - Always visible */}
        <div className="p-4 flex items-center cursor-pointer" onClick={toggleExpand} data-unique-id="9b9046fd-1976-47ed-a834-0f81ed51e252" data-file-name="components/landing/expandable-card.tsx">
          <div className="h-12 w-12 rounded-full bg-secondary flex items-center justify-center mr-3" data-unique-id="0e1e93e4-28d8-4b8a-9a7a-7f83890370be" data-file-name="components/landing/expandable-card.tsx">
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-unique-id="0a16e6eb-7e3a-4bab-99fc-78ead41f3271" data-file-name="components/landing/expandable-card.tsx">
          ...
          <div className="flex-1 min-w-0" data-unique-id="2175a27b-e0b6-4475-8edc-a9a981bc64f4" data-file-name="components/landing/expandable-card.tsx">
            <div className="flex items-center text-sm text-muted-foreground" data-unique-id="0579240c-8941-46c7-934c-893690d1f815" data-file-name="components/landing/expandable-card.tsx">
              <span className="font-medium" data-unique-id="079931af-4289-46c6-93aa-2e7e39742b67" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="afaf9a5b-691f-4b88-ae4b-032ce3fac625" data-file-name="components/landing/expandable-card.tsx">@VectorGuru</span></span>
              <span className="mx-1" data-unique-id="339dc39c-0e14-4253-ad04-cab5f462f3f2" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="0197dfcf-01d1-44ed-8d1f-33a5f8792899" data-file-name="components/landing/expandable-card.tsx">·</span></span>
              <span data-unique-id="3af0cb80-2709-47fb-a9ed-c876fffc0e0b" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="359b7668-930c-4d26-9234-cccc45225f24" data-file-name="components/landing/expandable-card.tsx">2h ago</span></span>
            </div>
            <p className="text-foreground font-medium mt-1 line-clamp-1" data-unique-id="efd7c073-56d9-4e72-ad92-9f69d1d4afcf" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="61d805b7-8704-4ed6-9ce8-92a192e6d216" data-file-name="components/landing/expandable-card.tsx">
              🧵 Starting a deep-dive on vector search pitfalls you probably run into…
            </span></p>
          </div>

          <div className="flex items-center ml-4" data-unique-id="a0500e12-2c9e-4b4c-a54c-2cec95ad3b39" data-file-name="components/landing/expandable-card.tsx">
            <span className="px-2 py-1 text-xs rounded-full border border-primary text-primary mr-2" data-unique-id="f882d553-ed22-4d71-8297-66696c624e0e" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="1f124eca-c1b5-4a15-9c0a-2a9abb428ff4" data-file-name="components/landing/expandable-card.tsx">
              Saved to SKOOP
            </span></span>
            <button ref={buttonRef} onClick={e => {
            e.stopPropagation();
            toggleExpand();
          }} className="p-1 rounded-full hover:bg-muted transition-colors" aria-expanded={isExpanded} aria-controls="expandable-content" data-unique-id="aad6d777-3d22-43e1-b9e0-f775b9222cdb" data-file-name="components/landing/expandable-card.tsx">
              <motion.div animate={{
              rotate: isExpanded ? 180 : 0
            }} transition={{
              duration: 0.3
            }} data-unique-id="13a14ea9-9797-4437-a107-bcde4b5de98a" data-file-name="components/landing/expandable-card.tsx">
        ...
        <AnimatePresence>
          ...
          duration: 0.4,
          ease: 'easeInOut'
        }} className="px-4 pb-4" tabIndex={-1} role="region" aria-labelledby="expandable-card-title" data-unique-id="86981db7-8afa-4d17-8508-2286f48694fa" data-file-name="components/landing/expandable-card.tsx" data-dynamic-text="true">
              {/* AI Summary */}
              <div className="border-l-4 border-primary pl-4 py-2 mb-4 bg-primary/5 rounded-r" data-unique-id="afb4ead7-9f4f-4f46-9d12-fed49712b792" data-file-name="components/landing/expandable-card.tsx">
                <p className="text-gray-700 dark:text-gray-300 font-medium" data-unique-id="522d77ed-4f1c-4b25-ac99-b451181ec3d2" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="059428c3-7a8c-4a1f-b4fd-a377e5563e10" data-file-name="components/landing/expandable-card.tsx">
              ...
              {/* Key Points */}
              <div className="mb-6" data-unique-id="3edd0eca-1377-4981-a220-ff89f7487f5f" data-file-name="components/landing/expandable-card.tsx">
                <h3 className="text-sm font-medium mb-2" data-unique-id="87114060-3416-4bef-a471-cbc7428f8684" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="5851dea9-fdf6-477a-97b4-1bb06db9cc48" data-file-name="components/landing/expandable-card.tsx">Key Points</span></h3>
                <ul className="space-y-2" data-unique-id="ab519939-b0cf-487c-8607-97e96a2d3815" data-file-name="components/landing/expandable-card.tsx">
                  <li className="flex items-start" data-unique-id="f4247d7d-c3ae-4ac2-a9b2-e60f4dc92802" data-file-name="components/landing/expandable-card.tsx">
                    <div className="mt-1 mr-2 p-1 rounded-full bg-primary/10" data-unique-id="65a40335-44a4-4fac-bb74-b35423a062b0" data-file-name="components/landing/expandable-card.tsx">
                      <Check className="h-3 w-3 text-primary" />
                    </div>
                    <span className="text-[#4B5563]" data-unique-id="621131c7-2a63-4d00-9d89-4d94f3e1a4e5" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="5bd24eca-70e8-4260-bd60-c861012f902d" data-file-name="components/landing/expandable-card.tsx">Fine-tune embeddings when domain jargon is heavy.</span></span>
                  </li>
                  <li className="flex items-start" data-unique-id="0c6aa431-baf5-484b-beeb-a88c16510a75" data-file-name="components/landing/expandable-card.tsx">
                    <div className="mt-1 mr-2 p-1 rounded-full bg-primary/10" data-unique-id="4b81e37d-2bd7-43ac-a0e3-bec10ec8041a" data-file-name="components/landing/expandable-card.tsx">
                      <Check className="h-3 w-3 text-primary" />
                    </div>
                    <span className="text-[#4B5563]" data-unique-id="2f1365c1-664b-4e33-9974-667af4521d68" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="216cb679-fd22-4654-90db-673b9fbc0412" data-file-name="components/landing/expandable-card.tsx">Normalize vectors and text metadata before similarity calc.</span></span>
                  </li>
                  <li className="flex items-start" data-unique-id="3265e45a-5853-43f6-9a59-52c5409a729a" data-file-name="components/landing/expandable-card.tsx">
                    <div className="mt-1 mr-2 p-1 rounded-full bg-primary/10" data-unique-id="6da6215a-6cfd-403a-a7a6-fc92195b03aa" data-file-name="components/landing/expandable-card.tsx">
                      <Check className="h-3 w-3 text-primary" />
                    </div>
                    <span className="text-[#4B5563]" data-unique-id="0fcf290e-c405-4371-a2f6-3752163d4951" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="07eb235a-bd0c-4ae7-a445-435965a19d24" data-file-name="components/landing/expandable-card.tsx">Post-filter with recency or popularity signals.</span></span>
                  </li>
                </ul>
              </div>

              {/* Footer Actions */}
              <div className="flex items-center justify-between pt-3 border-t border-border" data-unique-id="d77c0576-668e-43bb-823a-46f8e5c28c36" data-file-name="components/landing/expandable-card.tsx">
                <div className="flex items-center gap-2" data-unique-id="6fbb374b-f165-4642-99e4-927171c59493" data-file-name="components/landing/expandable-card.tsx">
                  <Button className="bg-gradient-to-r from-primary to-accent text-white" onClick={() => window.open('https://twitter.com/VectorGuru/status/123456', '_blank')} data-unique-id="0a7c8949-2ecd-4b33-80a6-0b5fd01a86d5" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="97fb06f6-beb0-4e05-884b-e8ba778410e0" data-file-name="components/landing/expandable-card.tsx">
                    Open Full Thread
                  </span></Button>
                  
                  <Button variant="ghost" size="icon" data-unique-id="55d06a2a-4efa-477b-8aa2-a0be493ea434" data-file-name="components/landing/expandable-card.tsx">
                    <Share2 className="h-4 w-4" />
                    <span className="sr-only" data-unique-id="a65e31d7-d4c1-45c7-a56e-660902bdda1d" data-file-name="components/landing/expandable-card.tsx"><span className="editable-text" data-unique-id="fa9c4022-6eec-40c7-bd93-3e592b30bdad" data-file-name="components/landing/expandable-card.tsx">Share</span></span>
                  </Button>
                </div>
              ...
              e.stopPropagation();
              toggleExpand();
            }} data-unique-id="caa0057a-579d-468e-905f-2402d6024df7" data-file-name="components/landing/expandable-card.tsx">
                  <ChevronUp className="h-4 w-4 mr-1" /><span className="editable-text" data-unique-id="c606b5a0-01e5-4238-a2f8-143cc858bc04" data-file-name="components/landing/expandable-card.tsx">
                  Collapse
                </span></Button>
              </div>
            </motion.div>}
